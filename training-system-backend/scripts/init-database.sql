...
VALUES 
('admin-001', 'admin', 'admin@company.com', '$2b$10$hashed_password_placeholder', '系统管理员', 'IT部', '系统管理员', 'active'),
('teacher-001', 'teacher', 'teacher@company.com', '$2b$10$hashed_password_placeholder', '教务管理员', '培训部', '教务主管', 'active'),
('counselor-001', 'counselor', 'counselor@company.com', '$2b$10$hashed_password_placeholder', '辅导员', '培训部', '辅导员', 'active');

-- 插入系统角色
INSERT INTO user_roles (id, user_id, role_name, granted_by) 
VALUES 
('role-001', 'admin-001', 'admin', 'admin-001'),
('role-002', 'teacher-001', 'teacher', 'admin-001'),
('role-003', 'counselor-001', 'counselor', 'admin-001');
...
VALUES 
('task-template-001', '面授培训', 'face-to-face', '课堂面授培训', '{"hasAttendance": true, "allowLate": false}', TRUE, 8, '面授教学', TRUE, 'admin-001'),
('task-template-002', '作业提交', 'homework', '学员作业提交和评分', '{"allowResubmit": true, "maxScore": 100}', TRUE, 4, '作业管理', TRUE, 'admin-001'),
('task-template-003', '在线课程', 'online-course', '在线学习课程', '{"trackProgress": true, "minDuration": 60}', FALSE, 2, '在线学习', TRUE, 'admin-001'),
('task-template-004', '小组讨论', 'discussion', '小组讨论活动', '{"minParticipants": 3, "duration": 90}', FALSE, 2, '互动讨论', TRUE, 'admin-001'),
('task-template-005', '考试测验', 'exam', '培训考试测验', '{"timeLimit": 120, "passScore": 80}', TRUE, 2, '考试评估', TRUE, 'admin-001');

-- 插入基础系统集成配置
INSERT INTO system_integrations (id, type, name, config, status)
VALUES 
('integration-001', 'hr', '人事系统集成', '{"endpoint": "", "token": "", "syncInterval": 3600}', 'inactive'),
('integration-002', 'wechat', '企业微信集成', '{"corpId": "", "corpSecret": "", "agentId": ""}', 'inactive'),
('integration-003', 'email', '邮件通知集成', '{"smtpHost": "", "smtpPort": 587, "username": "", "password": ""}', 'inactive');
